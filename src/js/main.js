...
import InfoTip from './utils/info-tip.js';
...
jQuery(function($) {
    ...
    jQuery('.mean-menu').meanmenu({
        ...
        meanContract: "<span class='bx bx-chevron-down'></span>"
    });
    ...
    try {
        ...
        for (let element of choiceElements) {
            ...
            let choiceObj = {};
            choiceObj.id = id;
            choiceObj.choice = new Choices(element, {
                searchEnabled: false,
                shouldSort: false,
            });
    ...
    try {
        ...
        for (let i=0; i<infoTips.length; i++) {
            ...
            //         placement = 'right';
            //     }
            //     var widthFrom = info.dataset.widthFrom;
            //     console.log(widthFrom);
            //     if (document.documentElement.clientWidth > widthFrom) {
            //         tippy(info, {
            //             content: contentId,
            //             theme: 'info-tip',
            //             allowHTML: true,
    ...
    // Buy Now Btn
    // $('body').append("<a href='https://themeforest.net/checkout/from_item/29758982?license=regular&support=bundle_6month&_ga=2.241839045.634514020.1646539215-1425290503.1590986634' target='_blank' class='buy-now-btn'>Купить</a>");
